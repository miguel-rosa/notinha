...
export const NoteOptionsStorage:FC = ({children}) => {
  ...
  return (
    <NoteOptionsContext.Provider value={{isNoteOptionsVisible, showOptions,hideOptions, noteId}}>
      {children}
...
const useNoteOptions = () => {
  ...
  if(!context) throw new Error('useNoteOptions should be used inside a NoteOptionsContext');
